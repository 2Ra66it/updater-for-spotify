...
public class PollService extends JobService {
    ...
    public static void setServiceAlarm(boolean isOn) {
        ComponentName component = new ComponentName(UpdaterApp.getContext(), PollService.class);
        JobInfo builder;
        ...
        JobScheduler jobScheduler = (JobScheduler) UpdaterApp.getContext().getSystemService(Context.JOB_SCHEDULER_SERVICE);
    ...
    private void makeNotification(int notificationId, FullSpotifyModel fullSpotifyModel) {
        //Launch app
        Resources resources = UpdaterApp.getContext().getResources();
